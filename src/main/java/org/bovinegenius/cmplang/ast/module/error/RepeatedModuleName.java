...
@Builder
public class RepeatedModuleName<LOC, NAME, IDENT extends Ident<NAME, LOC>> implements TypeError<LOC> {
    ...
    public String toString() {
        return String.format("Found duplicate module name; original: %s, duplicate: %s", this.original, this.duplicate);
    }
}
