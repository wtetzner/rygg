...
@Builder
public class ModuleTypeMismatch<LOC, NAME, VAL, KIND, DEF, TERM> implements TypeError<LOC> {
    @Getter @NonNull private final LOC location;
    @NonNull ModuleType<LOC, NAME, VAL, KIND, DEF> modType1;
    @NonNull ModuleType<LOC, NAME, VAL, KIND, DEF> modType2;
