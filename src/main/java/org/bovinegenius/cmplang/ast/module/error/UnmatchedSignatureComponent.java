...
@Builder
public class UnmatchedSignatureComponent<LOC, NAME, VAL, KIND, DEF> implements TypeError<LOC> {
    @Getter @NonNull private final LOC location;
    @NonNull private final Specification<LOC, NAME, VAL, KIND, DEF> spec;
    @NonNull private final ModuleType.Signature<LOC, NAME, VAL, KIND, DEF> sig1;
    @NonNull private final ModuleType.Signature<LOC, NAME, VAL, KIND, DEF> sig2;
