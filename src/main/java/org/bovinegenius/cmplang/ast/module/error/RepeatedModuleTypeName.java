...
@Builder
public class RepeatedModuleTypeName<LOC, NAME> implements TypeError<LOC> {
    ...
    public String toString() {
        return String.format("Found duplicate module type name; original: %s, duplicate: %s", this.original, this.duplicate);
    }
}
