...
@Builder
public class RepeatedSignatureName<LOC, NAME> implements TypeError<LOC> {
    ...
    public String toString() {
        return String.format("Found duplicate signature name; original: %s, duplicate: %s", this.original, this.duplicate);
    }
}
